...
export interface SupervisorConfig { baseUrl: string; controlTokenHash: string; providerCredentialRefs: ProviderCredentialRefs; persistenceBudget: PersistenceBudgetDefaults; projects: ProjectConfig[]; bridgeCommand: string[]; bridgeHost: string }
