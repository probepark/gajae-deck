...
export class SessionRegistry {
  ...
  async start(projectId: string, opts: { bridgeUrl?: string; bridgeToken?: string; routeId?: string; scopedTokenAlias?: string; restored?: boolean; resume?: string } = {}) {
    ...
    if (!bridgeUrl) {
      ...
      const resumeArgs = !opts.resume || opts.resume === "new" ? [] : opts.resume === "latest" ? ["--continue"] : ["--resume", opts.resume];
